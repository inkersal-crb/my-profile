  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-gray-900 shadow-lg z-50">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        {/* Logo */}
        <a href="#home" className="text-white text-2xl font-bold">Inkersal</a>
        ...
        <ul className="hidden md:flex space-x-6 text-gray-300">
          ...
          <li><a href="#experience" className="hover:text-yellow-300 transition">Experience</a></li>
          <li><a href="#certifications" className="hover:text-yellow-300 transition">Certifications</a></li>
